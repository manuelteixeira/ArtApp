...
{
    public class PathologySelectableCell : ViewCell
    {
        public static readonly BindableProperty NameProperty =
            BindableProperty.Create("Name", typeof(string), typeof(PathologySelectableCell), "Charmander");
        ...
        private Label lbName;
            ...
            //Label lbWeight, lbHeight;

        public PathologySelectableCell()
        {
